...
import 'package:tuncstoreadmin/models/product_model.dart';
import 'package:tuncstoreadmin/providers/diy_provider.dart';
import 'package:tuncstoreadmin/providers/products_provider.dart';
import 'package:tuncstoreadmin/widgets/product_tile.dart';
import 'package:tuncstoreadmin/widgets/title_text_widget.dart';
...
class _DIYPanelState extends State<DIYPanel> {
      ...
      body: SingleChildScrollView(
        child: Form(
          ...
          child: Column(
            ...
            children: [
              productSearchBox(productsProvider, diyProvider),
              ...
              productList(diyProvider, context),
              clearForm(diyProvider),
              approveButton(diyProvider, context),
            ],
          ),
        ),
      ),
  ...
  Padding productList(DIYProvider diyProvider, BuildContext context) {
    return Padding(
              ...
              child: SingleChildScrollView(
                child: Column(
                  children: diyProvider.productsCountList.isEmpty
                      ...
                      : diyProvider.productsCountList.map((productId) {
                          return ProductTile(
                            choice: true,
                            productId: productId,
                            onTap: () {
  ...
  ElevatedButton clearForm(DIYProvider diyProvider) {
  ...
  ElevatedButton approveButton(DIYProvider diyProvider, BuildContext context) {
    return ElevatedButton(
      onPressed: () async {
  ...
  SizedBox productSearchBox(
      ProductsProvider productsProvider, DIYProvider diyProvider) {
    return SizedBox(
      height: 400,
              ...
              children: [
                ...
                SizedBox(
                  ...
                  child: ListView.builder(
                    itemCount: diyProvider.searchController.text.isNotEmpty
                        ...
                        onTap: () {
                          setState(() {
                            ...
                            if (!diyProvider.productsCountList
                                .contains(product.id)) {
                              diyProvider.productsCountList.add(product.id);
                            }
                            log("2");
                          });
                        },
